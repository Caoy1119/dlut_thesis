...
\newcommand{\achievementsubsection}[1]{%
\subsubsection*{\textbf{~~#1}}%
    \vspace{-10pt}
\setstretch{1.35}\selectfont
}

\achievementsubsection{已发表论文}
\begin{enumerate}[label={[\arabic*]},itemsep=0pt,topsep=0pt,itemindent=0pt]
